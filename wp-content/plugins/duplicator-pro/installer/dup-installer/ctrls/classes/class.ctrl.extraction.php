...
class DUP_PRO_Extraction
{
    ...
    private function constructData()
    {
        ...
        $this->archive_items_count = $archiveConfig->fileInfo->dirCount + $archiveConfig->fileInfo->fileCount;
    ...
    public function getInitialFileProcessedString()
    {
        return 'Files processed: 0 of '.$this->archive_items_count;
    }
