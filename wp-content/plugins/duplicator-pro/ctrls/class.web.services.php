...
if (!class_exists('DUP_PRO_Web_Services')) {
    ...
    class DUP_PRO_Web_Services
    {
        ...
        public function init()
        {
            ...
            $this->add_class_action('wp_ajax_duplicator_pro_dismiss_plugin_activation_admin_notice', 'duplicator_pro_dismiss_plugin_activation_admin_notice');
...
//                    DUP_PRO_LOG::traceObject("upload infos for $package_id are", $providers);
        ...
        public function duplicator_pro_dismiss_plugin_activation_admin_notice() {
            self::ajax_json_wrapper(array('DUP_PRO_UI_Alert', 'resetReactivatePlugins'), 'duplicator_pro_dismiss_plugin_activation_admin_notice', $_POST['nonce'], 'export');
        }
